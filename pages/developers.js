...
export default function Developers() {
  return (
    <div className="bg-white dark:bg-black ease-in-out duration-500">
      <Navbar />
      <h1 className="text-3xl text-center w-full mt-10 tracking-wider"><a className="font-bold" href="https://discord.gg/fWJ9n3nwQu" target="_blank" rel="noreferrer">BETTER PW</a> DEVELOPERS</h1>
